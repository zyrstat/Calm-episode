...
for (u in 1:length(rnames))
{
  for(i in 1:length(seasons))
  {
    ...
    ggplot(pm_period[pm_period$orde<=eplen&pm_period$year<year2+1,],aes(x=factor(orde),y=PM2.5,fill=factor(d_n)))+geom_boxplot()+
      ...
      stat_summary(fun.y = "mean",geom = "point",aes(group=period),position=position_dodge(width=0.75),shape=23,size=1.5,fill="white")+
            facet_wrap(~year,ncol=4,scales = "free_y") +scale_fill_simpsons()+ 
    ...
    ggsave(paste0('/Users/zyr/Documents/PM2.5/datas/data_BJ_TS_BD/pm_period/PM25',
                  rnames[u],seasons[i],'pattern.png'),units="in",width=8, height=5, dpi=300)
    
    ggplot(pm_period[pm_period$orde<=eplen&pm_period$year<year2+1,],aes(x=factor(orde),y=PM10,fill=factor(d_n)))+geom_boxplot()+
      #geom_text(data=count_period[count_period$orde<=eplen,], aes(x=factor(orde), y=0.5, label=count),color='blue',vjust=0.7) +
      stat_summary(fun.y = "mean",geom = "point",aes(group=period),position=position_dodge(width=0.75),shape=23,size=1.5,fill="white")+
      facet_wrap(~year,ncol=4,scales = "free_y") +scale_fill_simpsons()+ 
    ...
    ggplot(pm_period[pm_period$orde<=eplen&pm_period$year<year2+1,],aes(x=factor(orde),y=SO2,fill=factor(d_n)))+geom_boxplot()+
      #geom_text(data=count_period[count_period$orde<=eplen,], aes(x=factor(orde), y=0.5, label=count),color='blue',vjust=0.7) +
      stat_summary(fun.y = "mean",geom = "point",aes(group=period),position=position_dodge(width=0.75),shape=23,size=1.5,fill="white")+
      facet_wrap(~year,ncol=4,scales = "free_y") +scale_fill_simpsons()+ 
    ...
    ggplot(pm_period[pm_period$orde<=eplen&pm_period$year<year2+1,],aes(x=factor(orde),y=CO,fill=factor(d_n)))+geom_boxplot()+
      #geom_text(data=count_period[count_period$orde<=eplen,], aes(x=factor(orde), y=0.5, label=count),color='blue',vjust=0.7) +
      stat_summary(fun.y = "mean",geom = "point",aes(group=period),position=position_dodge(width=0.75),shape=23,size=1.5,fill="white")+
      facet_wrap(~year,ncol=4,scales = "free_y") +scale_fill_simpsons()+ 
    ...
    ggplot(pm_period[pm_period$orde<=eplen&pm_period$year<year2+1,],aes(x=factor(orde),y=NO2,fill=factor(d_n)))+geom_boxplot()+
      #geom_text(data=count_period[count_period$orde<=eplen,], aes(x=factor(orde), y=0.5, label=count),color='blue',vjust=0.7) +
      stat_summary(fun.y = "mean",geom = "point",aes(group=period),position=position_dodge(width=0.75),shape=23,size=1.5,fill="white")+
      facet_wrap(~year,ncol=4,scales = "free_y") +scale_fill_simpsons()+ 
    ...
    ggplot(pm_period[pm_period$orde<=eplen&pm_period$year<year2+1,],aes(x=factor(orde),y=O3,fill=factor(d_n)))+geom_boxplot()+
      #geom_text(data=count_period[count_period$orde<=eplen,], aes(x=factor(orde), y=0.5, label=count),color='blue',vjust=0.7) +
      stat_summary(fun.y = "mean",geom = "point",aes(group=period),position=position_dodge(width=0.75),shape=23,size=1.5,fill="white")+
      facet_wrap(~year,ncol=4,scales = "free_y") +scale_fill_simpsons()+ 
