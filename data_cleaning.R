...
#---BLD added in 02-12
nc_BLD<- nc_open("/Users/zyr/Documents/PM2.5/datas/boundary_layer_dissipation.nc", write=FALSE, 
              readunlim=TRUE, verbose=FALSE, auto_GMT=TRUE, suppress_dimvals=FALSE)
print(nc_BLD)
latitudes_BLD=ncvar_get( nc = nc_BLD, varid = 'latitude')
longitudes_BLD=ncvar_get( nc = nc_BLD, varid = 'longitude')
time_BLD=ncvar_get( nc = nc_BLD, varid = 'time')
blds=(ncvar_get( nc = nc_BLD, varid = 'bld'))[,,1,]
#2013-01-01:0h --> 990552
blds=blds[,,time_BLD>=990552]
time_BLD=time_BLD[time_BLD>=990552]
